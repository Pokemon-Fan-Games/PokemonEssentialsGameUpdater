...
1. Descargar el archivo `PokeUpdater_1.1.3_PE16-18.zip` del [último release](https://github.com/Pokemon-Fan-Games/PokemonEssentialsGameUpdater/releases/latest).
